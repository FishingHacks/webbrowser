...
modifyDefault(navigator, 'appCodeName', ['Mozilla', 'Peacock', 'Browser'].random());
modifyDefault(navigator, 'appName', ['Netscape', 'Peacock', 'Browser'].random());
...
global.alert = window.alert = (message) => {
	let url = (window.location.href.startsWith('peacock') || window.location.href.startsWith('about') || window.location.href.startsWith('browser')) ? 'Browser' : window.location.href;
...
if (window.location.protocol == 'peacock:' || window.location.protocol == 'file:' || window.location.protocol == 'browser:' || window.location.protocol == 'about:') {
